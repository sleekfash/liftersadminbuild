...
class DisbursementRequestPolicy
{
    ...
    public function verify(User $user,mixed $model): bool { return $user->hasRole(RoleCode::BRANCH_MANAGER->value) && $this->sameBranch($user,$model); }
    ...
    public function financeReview(User $user,mixed $model): bool { return $user->hasRole(RoleCode::FINANCE_OFFICER->value) && $this->sameBranch($user,$model); }
    public function authorize(User $user,mixed $model): bool { return false; }
    public function markPaid(User $user,mixed $model): bool { return $user->hasRole(RoleCode::FINANCE_OFFICER->value) && $this->sameBranch($user,$model); }
    public function review(User $user,mixed $model): bool { return $user->hasRole(RoleCode::FINANCE_OFFICER->value) && $this->sameBranch($user,$model); }
    ...
    public function post(User $user,mixed $model): bool { return $user->hasRole(RoleCode::FINANCE_OFFICER->value) && $this->sameBranch($user,$model); }
}
