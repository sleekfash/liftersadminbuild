...
{
    use HasFactory;
    protected $fillable = ['reconciliation_run_id', 'related_disbursement_request_id', 'related_treasury_transaction_id', 'severity', 'status', 'description', 'variance', 'resolved_by', 'resolved_at', 'resolution_note'];
    protected $casts = [
