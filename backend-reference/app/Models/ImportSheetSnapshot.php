...
class ImportSheetSnapshot extends Model
{
    use HasFactory;
    protected $fillable = ['import_batch_id', 'sheet_name', 'title_blocks', 'heading_map', 'raw_payload'];
    protected $casts = [
    ...
    public function batch(){return $this->belongsTo(ImportBatch::class,'import_batch_id');} public function rows(){return $this->hasMany(ImportRow::class);}
}
